export default function Header(){
    return(
      ...
      <div className='flex flex-wrap items-center justify-between gap-4 w-full max-w-screen-xl mx-auto'>
        <a href="" className="logo">Tom Dixon MD<span>| Family Doctor</span></a>
        ...
        <div id="collapseMenu"
          ...
          <ul
            ...
            <li className='max-lg:border-b max-lg:py-3 px-3'>
              <a href='' className='hover:text-[#ff9900e5] text-[#ff9900e5]  block text-base'>Home</a>
            </li>
            <li className='max-lg:border-b max-lg:py-3 px-3'><a href=''
              className='hover:text-[#ff9900e5] text-gray-600  block text-base'>About</a>
            </li>
            <li className='max-lg:border-b max-lg:py-3 px-3'><a href=''
              className='hover:text-[#ff9900e5] text-gray-600  block text-base'>Services</a>
            </li>
            <li className='max-lg:border-b max-lg:py-3 px-3'><a href=''
              className='hover:text-[#ff9900e5] text-gray-600  block text-base'>Patient Info</a>
            </li>
            <li className='max-lg:border-b max-lg:py-3 px-3'><a href=''
              className='hover:text-[#ff9900e5] text-gray-600  block text-base'>Contact</a>
            </li>
          </ul>
        </div>

        <div className='flex items-center max-lg:ml-auto space-x-5'>
          <button type="button" className=" hover:text-blue-800 px-3.5 py-[7px] rounded text-black text-[15px] font-semibold flex items-center justify-center gap-2">
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"
              className="cursor-pointer fill-black inline w-4 h-4 ">
